...
def check_training_material(body: TrainingMaterial) -> ApiResponse[ComplianceCheckResult]:
...
def get_training_material_result(material_id: str) -> ApiResponse[ComplianceCheckResult]:
