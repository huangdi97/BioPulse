...
class CustomerService(BaseService):
    ...
    def create_customer(self, name: str, title: str, hospital: str,
                        department: str, specialty: str, phone: str,
                        email: str, tags: List[str], user_id: int) -> dict:
    ...
    def list_customers(self, name: Optional[str] = None,
