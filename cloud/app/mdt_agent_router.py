...
@router.get("/sessions/{session_id}/agents", summary="List all Framework Agents")
...
@router.post("/sessions/{session_id}/assign", status_code=201, summary="Assign Tasks")
def assign_tasks(
    session_id: int,
...
@router.get("/sessions/{session_id}/tasks", summary="List all Session Tasks")
