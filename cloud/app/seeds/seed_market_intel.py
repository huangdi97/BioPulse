...
def seed_market_intel(conn: sqlite3.Connection) -> None:
    ...
    items = [
        ...
        (
            ...
            "policy",
            "国家医保目录调整方案征求意见",
            "国家医保局发布2026年医保目录调整方案征求意见稿，新增谈判药品目录",
        ...
        (
            ...
            "policy",
            "DRG/DIP支付改革全面推行",
            "国家卫健委要求2026年底前全国三级医院全面实施DRG/DIP付费",
        ...
        (
            ...
            "industry",
            "2026中国医药市场年度报告发布",
            "报告显示中国医药市场总规模突破2.5万亿元，创新药占比提升至35%",
        ...
        (
            ...
            "industry",
            "医药行业Q2投融资数据",
            "Q2医药行业投融资总额320亿元，同比增长18%，集中在生物技术和创新药领域",
