...
# Pattern confidence weights for the holographic_audit decision chain.
...
@dataclass
class HolographicFinding:
    """One holographic_audit anomaly finding."""
...
class HolographicResult:
    ...
    suspicion_level: str
    decision: str
    findings: list[HolographicFinding] = field(default_factory=list)
