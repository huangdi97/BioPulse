"""L4 Meta-Cognitive: Analyzer — classifies failures and produces structured analysis."""
...
class Analyzer:
    """Analyzes step failures — non-LLM classification first, LLM only for complex cases."""

    # Failure categories detectable without LLM
    ...
    def analyze(self, task: str, failed_step: str, result: dict, context: dict | None = None) -> Analysis:
        ...
        # Step 2: If simple category, return immediately
        ...
        # Step 3: Complex failure — use LLM analysis
