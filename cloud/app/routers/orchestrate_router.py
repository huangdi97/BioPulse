...
@router.post("/templates/create", status_code=status.HTTP_201_CREATED, tags=["Orchestration"])
def create_template(
    body: TemplateCreate,
...
@router.get("/templates/list", tags=["Orchestration"])
def list_templates(
...
@router.post("/run", status_code=status.HTTP_201_CREATED, tags=["Orchestration"])
