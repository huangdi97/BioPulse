...
TABLE_AGENT_SKILLS_COLS = [
    ...
    "capabilities", "confidence", "priority", "enabled", "created_at", "updated_at"
]
...
TABLE_BENCHMARK_REPORTS_COLS = [
    "id", "report_id", "report_name", "report_type", "data_source", "summary",
    "metrics", "period", "created_at"
]
...
TABLE_CAUSAL_GRAPHS_COLS = [
    "id", "graph_id", "decision_id", "graph_data", "summary", "node_count",
...
TABLE_COUNTERFACTUAL_SCENARIOS_COLS = [
    "id", "scenario_id", "strategy_id", "base_description", "variable_changes",
    "predicted_outcome", "confidence", "created_by", "created_at"
]

TABLE_CROSS_CASE_INSIGHTS_COLS = [
    "id", "title", "insight_type", "summary", "detail", "evidence",
    "confidence", "applicability", "source_run_ids", "is_active", "created_by",
    "created_at", "updated_at"
]
...
TABLE_CUSTOMERS_COLS = [
    "id", "name", "title", "hospital", "department", "specialty", "phone",
    "email", "tags", "status", "created_by", "created_at", "updated_at"
]
...
TABLE_EFFECT_METRICS_COLS = [
    "id", "metric_id", "agent_role", "metric_type", "metric_value", "metric_unit",
    "source_table", "source_row_id", "period_start", "period_end", "created_at"
]
...
TABLE_FED_AUDIT_CONTRIBUTIONS_COLS = [
    ...
    "payload_summary", "weight", "verified", "verified_by",
    "audit_chain_hash", "created_at"
]

TABLE_FEDERATED_ROUNDS_COLS = [
    "id", "round_id", "model_name", "round_number", "participant_count",
    "aggregation_method", "global_metrics", "status", "created_at", "completed_at"
]
...
TABLE_MARKET_INTEL_SOURCES_COLS = [
    "id", "name", "source_type", "target_keywords", "is_active", "created_by",
    "created_at", "updated_at"
]

TABLE_MCP_TOOLS_COLS = [
    "id", "tool_name", "description", "tool_version", "endpoint_url",
    "input_schema", "output_schema", "auth_required", "enabled", "created_by",
    "created_at", "updated_at"
]

TABLE_MDT_OPINIONS_COLS = [
    "id", "session_id", "participant_id", "round_number", "opinion", "summary",
    "sentiment", "confidence", "key_points", "ai_response_raw", "tokens_used",
    "created_at"
]

TABLE_MDT_PARTICIPANTS_COLS = [
    "id", "session_id", "agent_role_id", "role_name", "stance", "vote_weight",
    "created_at"
]
...
TABLE_MEMORY_CONSOLIDATION_LOG_COLS = [
    "id", "consolidation_type", "source_table", "item_count", "items_promoted",
    "items_pruned", "items_superseded", "duration_ms", "status", "details",
    "created_at"
]
...
TABLE_NOTIFICATIONS_COLS = [
    "id", "user_id", "template_id", "title", "body", "category", "ref_type",
    "ref_id", "context_json", "is_read", "read_at", "created_at"
]
...
TABLE_SENSOR_SESSIONS_COLS = [
    "id", "session_id", "session_name", "event_type", "location", "start_time",
    "end_time", "data_summary", "status", "created_at"
]
...
TABLE_TRAINING_SESSIONS_COLS = [
    ...
    "answers", "feedback", "difficulty_used", "next_difficulty", "completed_at",
    "created_at"
]
...
TABLE_WORKING_MEMORY_COLS = [
    "id", "session_id", "slot_key", "slot_value", "slot_type", "ttl_seconds",
