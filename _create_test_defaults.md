Create the file tests/agent_runtime/test_tool_bridge_defaults.py with this exact Python code:

```python
"""Tests for tool_bridge_defaults module."""

from cloud.app.agent_runtime.tool_bridge_defaults import DEFAULT_TOOLS, BRAIN_TOOLS
...
Write ONLY this file, nothing else. Then run: python -m py_compile tests/agent_runtime/test_tool_bridge_defaults.py
