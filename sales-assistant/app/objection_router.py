...
@router.post("/objection", response_model=ApiResponse[ObjectionResponse], summary="异议处理", description="处理客户异议并获取应答建议", tags=["情报"])
...
@router.get("/objections", summary="异议列表", description="获取异议列表", tags=["情报"])
def list_objections():
    """获取objections。"""
    return success(data=[])
