...
def create_quotation(payload: dict[str, Any], _: dict = Depends(require_scope("research"))) -> dict[str, Any]:
...
def update_quotation(id: int, payload: dict[str, Any], _: dict = Depends(require_scope("research"))) -> dict[str, Any]:
...
def delete_quotation(id: int, _: dict = Depends(require_scope("research"))) -> dict[str, Any]:
