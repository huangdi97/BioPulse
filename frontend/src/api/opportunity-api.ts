...
export async function fetchOpportunities(): Promise<OppRecord[]> {
  try {
    ...
    return [
      { id: 1, title: '新药进院项目', hospital: '北京协和医院', amount: '¥500,000', stage: 'negotiation', owner: '张三', probability: 75, expectedClose: '2026-06-30', createdAt: '2026-05-01' },
      { id: 2, title: '学术会议合作', hospital: '上海瑞金医院', amount: '¥300,000', stage: 'follow_up', owner: '李四', probability: 50, expectedClose: '2026-07-15', createdAt: '2026-05-10' },
      { id: 3, title: '临床研究赞助', hospital: '广州中山医院', amount: '¥800,000', stage: 'lead', owner: '王五', probability: 30, expectedClose: '2026-08-01', createdAt: '2026-05-20' },
      { id: 4, title: '药品采购合同', hospital: '杭州第一人民医院', amount: '¥200,000', stage: 'closed_won', owner: '赵六', probability: 100, expectedClose: '2026-05-25', createdAt: '2026-04-15' },
    ]
  }
}
...
export async function fetchBiddings(): Promise<Bidding[]> {
  try {
    ...
    return [
      { id: 1, opportunityId: 1, title: '新药进院投标', status: 'preparing', deadline: '2026-06-15', amount: '¥500,000', createdAt: '2026-05-01' },
      { id: 2, opportunityId: 3, title: '临床研究设备采购', status: 'submitted', deadline: '2026-06-30', amount: '¥800,000', createdAt: '2026-05-15' },
    ]
  }
}
...
export async function fetchOppStats(): Promise<Record<string, unknown>> {
  try {
    ...
    return { total: 4, active: 3, totalAmount: '¥1,800,000', avgProbability: 64, winRate: 25 }
  }
}
