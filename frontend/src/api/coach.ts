...
export async function fetchScenarios(): Promise<Scenario[]> {
  return withFallback(
    ...
    () => [
      { id: 1, name: '新药处方推广', description: '向医生推广新上市药品的处方', difficulty: 'medium' as const, category: '产品推广', duration: 30 },
      { id: 2, name: '学术会议邀约', description: '邀请HCP参加学术会议', difficulty: 'easy' as const, category: '学术推广', duration: 15 },
      { id: 3, name: '合规异议处理', description: '应对HCP关于药品价格的异议', difficulty: 'hard' as const, category: '异议处理', duration: 20 },
      { id: 4, name: '竞品对比拜访', description: '处理HCP对竞品的偏好', difficulty: 'hard' as const, category: '竞争分析', duration: 25 },
    ]
  )
}
...
export async function fetchSessions(): Promise<Session[]> {
  return withFallback(
    ...
    () => [
      { id: 1, scenarioId: 1, scenarioName: '新药处方推广', status: 'completed' as const, createdAt: '2026-05-28', score: 85, duration: 28 },
      { id: 2, scenarioId: 3, scenarioName: '合规异议处理', status: 'completed' as const, createdAt: '2026-05-25', score: 72, duration: 22 },
      { id: 3, scenarioId: 2, scenarioName: '学术会议邀约', status: 'active' as const, createdAt: '2026-05-30' },
      { id: 4, scenarioId: 4, scenarioName: '竞品对比拜访', status: 'paused' as const, createdAt: '2026-05-29', duration: 10 },
    ]
  )
}
