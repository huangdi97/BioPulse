...
@router.get("/team/{team_id}/stats", summary="团队统计", description="获取指定团队的成员统计和看板聚合数据", tags=["团队"])
...
@router.get("/team/{team_id}/members", summary="成员列表", description="获取指定团队的成员列表信息", tags=["团队"])
...
@router.get("/team/{team_id}/compliance", summary="团队合规", description="获取指定团队的合规执行数据", tags=["团队"])
...
@router.get("/team/{team_id}/performance", summary="团队绩效", description="获取指定团队的绩效评估数据", tags=["团队"])
