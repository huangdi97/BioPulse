...
@router.get("/me/profile", summary="个人资料", description="获取当前登录员工的个人资料信息")
...
@router.get("/me/tasks", summary="我的任务", description="获取当前登录员工的任务列表")
...
@router.get("/me/compliance", summary="合规数据", description="获取当前登录员工的合规执行数据")
...
@router.get("/me/performance", summary="绩效数据", description="获取当前登录员工的绩效评估数据")
...
@router.get("/me/trend", summary="趋势数据", description="获取当前登录员工的工作趋势分析数据")
