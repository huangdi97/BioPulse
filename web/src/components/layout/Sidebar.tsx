...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-full w-60 bg-[var(--clr-gray-100)] text-[var(--clr-text-inverse)] flex flex-col z-50">
      <div className="flex items-center gap-2 px-5 h-16 border-b border-[var(--clr-gray-70)]">
