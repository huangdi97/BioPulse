...
SERVICES=(
    ...
    "market-access:8007:market_access.app.main:app"
    "clinical-ops:8010:clinical_ops.app.main:app"
    "patient-engage:8011:patient_engage.app.main:app"
...
echo "  Market-Access:  http://localhost:8007"
echo "  Clinical-Ops:   http://localhost:8010"
echo "  Patient-Engage: http://localhost:8011"
